...
public class hardFunctions {
        ...
        void testHardNewtonMethod() {
            ...
            Assertions.assertEquals(-1.0000013220742012, newtonMethod.andThen(simple).apply(16), 1e-10);
            Assertions.assertEquals(-1.000001534880779, newtonMethod.andThen(simple).apply(25), 1e-10);
        }
